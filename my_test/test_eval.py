...
@click.command()
@click.option('--input', '-i', default='latest_527.ckpt', help='Path to checkpoint')
@click.option('--output', '-o', default='data/outputs/eval_real', help='Directory to save recording')
@click.option('--robot_ip', '-ri', default='192.168.58.2', help="UR5's IP address e.g. 192.168.0.204")
...
def main(input, output, robot_ip, match_dataset, match_episode,
    ...
    if 'diffusion' in cfg.name:
        ...
        policy.num_inference_steps = 32 # DDIM inference iterations #16
             ...
             Gripper(shm_manager=shm_manager) as gp, \
                ...
                while True:
                    ...
                    while True:
                        ...
                        text2 = str("q-Exit program |c-Exit human control, start policy control")
                        cv2.putText(
                            show_images,
                            text2,
                            (10,50),
                    ...
                    try:
                        ...
                        while True:
                            ...
                            #     this_target_pose[[0,1,2,3,4,5]] += action[-1]
                            ...
                            text2 = 'Hand control back to human'
                            cv2.putText(
                                show_images,
                                text2,
                                (10,40),
                            ...
                            cv2.imshow('default', show_images)
